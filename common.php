 ...
 * @author Andreas Gohr <andi@splitbrain.org>
 */
function wl($id='',$more='',$script='',$canonical=false){
  global $conf;
  global $wpdb;
  ...
  $id = str_replace("_", "-", $id); // wp's post_name is dash-separated
  $page = $wpdb->get_results("SELECT * FROM $wpdb->posts " .
                             "WHERE post_status = 'static' " .
                             "and post_name='$id'");
  $id1 = $page[0]->ID;
  if($id1 == ''){
    $xlink .= 'wp-admin/page-new.php?title='.$id;
}  
else{  
